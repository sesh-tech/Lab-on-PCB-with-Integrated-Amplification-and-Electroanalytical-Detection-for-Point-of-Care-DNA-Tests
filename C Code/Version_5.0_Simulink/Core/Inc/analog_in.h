...
#define ANALOG_IN_H_
	...
	#define __MAX_CHANNELS1__ 5			//Maximum number of allowable channels for the ADC outputs, remove and replace in the variable declarations
	#define __MAX_CHANNELS2__ 2			//Maximum number of allowable channels for the ADC outputs, remove and replace in the variable declarations
	#define __MAX_CHANNELS3__ 0			//Maximum number of allowable channels for the ADC outputs, remove and replace in the variable declarations
	...
	//#define ADC3self					//Declaration to the file guards and unnecessary variable declaration

	#ifdef ADC1self							//Use #define to enable channel, use only in analog.h file
	extern uint16_t adc1values[];	//Array input to the DMA, total number of channels is the size of the array, counting from 1
	#endif									//Endif file guard

	#ifdef ADC2self							//Use #define to enable channel, use only in analog.h file
	extern uint16_t adc2values[];	//Array input to the DMA, total number of channels is the size of the array, counting from 1
	#endif									//Endif file guard

	#ifdef ADC3self							//Use #define to enable channel, use only in analog.h file
	extern uint16_t adc3values[__MAX_CHANNELS3__];	//Array input to the DMA, total number of channels is the size of the array, counting from 1
	#endif									//Endif file guard
